...
(function() {
  ...
  Spacejam = (function(_super) {
    ...
    Spacejam.prototype.testPackages = function(options) {
      ...
      if (options['xunit-out'] != null) {
        expect(options['xunit-out']).to.be.a('string');
      }
      ...
      this.meteor.on("ready", (function(_this) {
        return function() {
          ...
          if (options['xunit-out']) {
            ...
            spawnOptions = {
              pipeToFile: options['xunit-out']
            };
          }
          return _this.runPhantom(_this.meteor.options["root-url"], options['phantomjs-options'], options['phantomjs-script'], scriptArgs, spawnOptions, pipeClass);
        };
      })(this));
    ...
    Spacejam.prototype.runPhantom = function(url, options, script, scriptArgs, spawnOptions, pipeClass) {
      ...
      return this.phantomjs.run(url, options, script, scriptArgs, spawnOptions, pipeClass);
    };
