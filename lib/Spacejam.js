...
(function() {
  ...
  Spacejam = (function(_super) {
    ...
    function Spacejam() {
      ...
      return Spacejam.__super__.constructor.apply(this, arguments);
    }
    ...
    Spacejam.prototype.defaultOptions = {
    ...
    Spacejam.prototype.testPackages = function(options) {
      ...
      this.meteor.on("ready", (function(_this) {
        return function() {
          ...
          return _this.runPhantom(_this.meteor.options["root-url"], options['phantomjs-script']);
        };
      })(this));
    ...
    Spacejam.prototype.runPhantom = function(url, script) {
      ...
      return this.phantomjs.run(url, script);
    };
