...
(function() {
  ...
  Phantomjs = (function(_super) {
    ...
    Phantomjs.prototype.run = function(url, options, script, scriptArgs, spawnOptions, pipeClass) {
      var env, finalSpawnOptions, spawnArgs;
      if (options == null) {
      ...
      this.childProcess.spawn("phantomjs", spawnArgs, finalSpawnOptions, pipeClass);
