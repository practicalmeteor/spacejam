...
(function() {
  ...
  Meteor = (function(_super) {
    ...
    Meteor.prototype.testPackages = function(options) {
      var args, cwd, env, packages, _base, _testPackages;
      ...
      if (!fs.existsSync(cwd + '/.meteor/packages') && !fs.existsSync(cwd + '/package.js')) {
      ...
      packages = this.options._ != null ? this.options._.slice(1) : [];
      if (packages.length > 0) {
        _testPackages = this._globPackages(packages);
    ...
    Meteor.prototype.kill = function(signal) {
      ...
      log.debug("Meteor.kill() @childProcess?=", this.childProcess != null);
      log.debug("Meteor.kill() @mongodb?=", this.mongodb != null);
